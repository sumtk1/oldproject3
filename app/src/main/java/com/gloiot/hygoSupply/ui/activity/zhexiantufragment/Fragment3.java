...
public class Fragment3 extends BaseFragment {
    ...
    public void initData() {
        ...
        if (dianPuZhuantai.equals("是")) {
            ...
            requestHandleArrayList.add(requestAction.shop_sta_order(this, zhanghao));
        } else {
    ...
    public void requestSuccess(int requestTag, JSONObject response, int showLoad) throws JSONException {
        ...
        switch (requestTag) {
            case ConstantUtils.TAG_shop_sta_order:
...
//                    mLineChart.setVisibleXRange(1,17);
                        ...
                        //创建一条折线的图表
                        LineChartManager.initSingleLineChart(context, mLineChart, xValues, yValue, 2);
                    } else {
                        rl_wushuju.setVisibility(View.VISIBLE);
                    }
                }
