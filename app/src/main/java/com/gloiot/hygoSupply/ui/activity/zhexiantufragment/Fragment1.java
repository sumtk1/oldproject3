...
public class Fragment1 extends BaseFragment {
    ...
    private List<TiemData> timeList;
    private List<TiemData> timeListAll;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (dianPuZhuantai.equals("是")) {
            ...
            requestHandleArrayList.add(requestAction.shop_sta_benefit(this, zhanghao));
        } else {
    ...
    public void requestSuccess(int requestTag, JSONObject response, int showLoad) throws JSONException {
        ...
        switch (requestTag) {
            case ConstantUtils.TAG_shop_sta_benefit:
                if (response.getString("状态").equals("成功")) {
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        //创建一条折线的图表
                        LineChartManager.initSingleLineChart(context, mLineChart, xValues, yValue, 0);
                    } else {
                        rl_wushuju.setVisibility(View.VISIBLE);
                    }
