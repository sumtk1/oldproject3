...
import com.gloiot.hygoSupply.ui.activity.shangpinshangchuan.ChangeShangpinMiaoshuActivity;
...
public class ViewShangpinMiaoshuActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public int initResource() {
        return R.layout.activity_viewshangpin_miaoshu;
    }

    @Override
    public void initData() {
        CommonUtils.setTitleBar((Activity) mContext, true, "图文详情", "");
        ...
        if (ViewProductActivity.ALLSHANGPINMIAOSHU.size() != 0) {
            allmiaoshu.clear();
            Iterator<MiaoShuBean> iterator = ViewProductActivity.ALLSHANGPINMIAOSHU.iterator();
    ...
    private void listviewset() {
        adapter = new CommonAdapter<MiaoShuBean>(this, R.layout.item_shangpin_miaoshu, allmiaoshu) {
            ...
            public void convert(final ViewHolder holder, MiaoShuBean miaoshuBean) {
                ...
                holder.setVisible2(R.id.iv_item_shangpin_miaoshu_del2,false);
...
//                            ConstantUtils.SP_ALLSHANGPINMIAOSHU.addAll(allmiaoshu);
    ...
    public void initComponent() {
        ...
        interceptRelativeLayout.setAllowIds(new int[]{R.id.iv_toptitle_back});
