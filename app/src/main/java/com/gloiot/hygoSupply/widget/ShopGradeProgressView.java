...
public class ShopGradeProgressView extends View {
    ...
    public ShopGradeProgressView(Context context) {
        super(context);
    ...
    public ShopGradeProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public ShopGradeProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public int calculateProgress(int credits) {
        if (credits <= 200) {
            return (int) (credits * ((double) leftPointX / 200));
        } else if (credits <= 1000) {
            return leftPointX + (int) ((credits - 200) * ((double) (middlePointX - leftPointX) / 800));
        } else if (credits <= 10000) {
            return middlePointX + (int) ((credits - 1000) * ((double) (rightPointX - middlePointX) / 9000));
        } else if (credits <= 100000) {
            return middlePointX + (int) ((credits - 10000) * ((double) (rightPointX - middlePointX) / 90000));
        }
        return 0;
    }
