...
public class ExpandableTextView extends TextView {
    ...
    private static final int MAX_LINES_ON_SHRINK = 1; //初始行数
    private static final int TO_EXPAND_HINT_COLOR = 0xFFff7f29;
    private static final int TO_SHRINK_HINT_COLOR = 0xFFff7f29;
