...
import com.gloiot.chatsdk.chatui.keyboard.widget.AutoHeightLayout;
...
public class XhsEmoticonsKeyBoard extends AutoHeightLayout implements View.OnClickListener, EmoticonsFuncView.OnEmoticonsPageViewListener,
    ...
    protected RelativeLayout rl_keybord;
    ...
    public void setShowExpression(boolean showExpression) {
        isShowExpression = showExpression;
    }
    ...
    protected void initView() {
        ...
        rl_keybord = (RelativeLayout) findViewById(R.id.rl_keybord);
    ...
    protected void initEditView() {
        ...
        mEtChat.addTextChangedListener(watcher = new TextWatcher() {
            @Override
    ...
    public void toggleFuncView(int key) {
        showText();
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_voice_or_text) {
            // TODO 发送语音
            if (!canVoice) {
                Toast.makeText(mContext, "客服暂不支持语音消息", Toast.LENGTH_SHORT).show();
                return;
            }
            if (!requestVoicePermission.voiceResult()) {
                return;
            }
            if (mRlInput.isShown()) {
                mBtnVoiceOrText.setImageResource(R.drawable.btn_voice_or_text_keyboard);
    ...
    public RelativeLayout getRl_keybord() {
        return rl_keybord;
    }
    ...
    public void hideFunc() {
        mLyKvml.setVisibility(GONE);
    }

    private RequestVoicePermission requestVoicePermission;
    public void setRequestVoicePermission(RequestVoicePermission requestVoicePermission) {
        this.requestVoicePermission = requestVoicePermission;
    }
    public interface RequestVoicePermission {
        boolean voiceResult();
    }
}
