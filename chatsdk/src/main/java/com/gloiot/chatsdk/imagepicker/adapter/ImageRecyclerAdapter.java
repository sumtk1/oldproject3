package com.gloiot.chatsdk.imagepicker.adapter;
...
import com.gloiot.chatsdk.imagepicker.ui.ImageBaseActivity;
import com.gloiot.chatsdk.imagepicker.ui.ImageGridActivity;
import com.gloiot.chatsdk.imagepicker.util.Utils;
import com.gloiot.chatsdk.imagepicker.view.SuperCheckBox;
...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new CameraViewHolder(mInflater.inflate(R.layout.ip_adapter_camera_item,parent,false));
        }
        return new ImageViewHolder(mInflater.inflate(R.layout.ip_adapter_image_list_item,parent,false));
    }
