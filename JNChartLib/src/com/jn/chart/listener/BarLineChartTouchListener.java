...
//                        if (offset != 0) {
//                            if (offset < 0) {
//                                if (Math.abs(offset) > standardWidth / 2) {
//                                    y = -(standardWidth + offset);
////                                    mMatrix.postTranslate(0, -(standardWidth + offset));
////                                    if (l != null)
////                                        l.onChartTranslate(event, 0, -(standardWidth + offset));
//                                } else {
//                                    y = -offset;
////                                    mMatrix.postTranslate(0, -offset);
////                                    if (l != null)
////                                        l.onChartTranslate(event, 0, -offset);
//                                }
//                            } else {
//                                if (Math.abs(offset) < standardWidth / 2) {
//                                    y = -offset;
...
//                                }
//                            }
//                            Log.e("TAG", "onTouch:offset: " + offset + "y: " + y);
//                            offset = 0;
//                        }
...
//                        Utils.postInvalidateOnAnimation(mChart); // This causes computeScroll to fire, recommended for this by Google
                ...
                if (offset != 0) {
                    if (offset < 0) {
                        if (Math.abs(offset) > standardWidth / 2) {
                            mMatrix.postTranslate(-(standardWidth + offset),0);
                            if (l != null)
                                l.onChartTranslate(event, -(standardWidth + offset),0);
                        } else {
                            mMatrix.postTranslate(-offset,0);
                            if (l != null)
                                l.onChartTranslate(event,  -offset,0);
                        }
                    } else {
                        if (Math.abs(offset) < standardWidth / 2) {
                            mMatrix.postTranslate( -offset,0);
