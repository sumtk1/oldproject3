...
import com.jn.chart.animation.EasingFunction;
...
import com.jn.chart.interfaces.dataprovider.ChartInterface;
...
import com.jn.chart.renderer.DataRenderer;
import com.jn.chart.renderer.LegendRenderer;
...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    public boolean isLinechat() {
        return isLinechat;
    }

    public void setLinechat(boolean linechat) {
        isLinechat = linechat;
    }

    private boolean isLinechat;
    ...
    protected void drawDescription(Canvas c) {
        ...
        if (!mDescription.equals("")) {
            ...
            if (mDescriptionPosition == null) {
                ...
                c.drawText(mDescription, mViewPortHandler.offsetLeft() +mDescription.length()*16f+100,
