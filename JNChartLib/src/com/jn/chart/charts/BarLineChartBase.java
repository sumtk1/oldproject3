...
import com.jn.chart.components.XAxis.XAxisPosition;
...
import com.jn.chart.highlight.ChartHighlighter;
...
import com.jn.chart.jobs.AnimatedMoveViewJob;
import com.jn.chart.jobs.AnimatedZoomJob;
import com.jn.chart.jobs.MoveViewJob;
import com.jn.chart.jobs.ZoomJob;
import com.jn.chart.listener.BarLineChartTouchListener;
import com.jn.chart.listener.OnDrawListener;
import com.jn.chart.renderer.XAxisRenderer;
import com.jn.chart.renderer.YAxisRenderer;
import com.jn.chart.utils.PointD;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
        extends com.jn.chart.charts.Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    protected float[] getMarkerPosition(Entry e, Highlight highlight) {
        ...
        if (this instanceof BarChart) {
            ...
            if (this instanceof com.jn.chart.charts.HorizontalBarChart) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        standardWidth = getWidth() / 9;
        middle = 4 * standardWidth + 60;
        mChartTouchListener.setStandardWidth(standardWidth);
        mChartTouchListener.setChartMiddle(middle);
    }
}
